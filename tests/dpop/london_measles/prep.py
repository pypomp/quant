"""
Shared setup for the single-unit London measles DPOP benchmark.

The experiment is represented as a one-unit PanelPomp so that the panel
DPOP training code can evaluate all search replicates in one call.
"""
...
print(f"Running at RUN_LEVEL {RUN_LEVEL}")
...
BETA1 = 0.0 if ALPHA == 0.0 else 0.9
