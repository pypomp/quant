...
# | label: load-data
# | echo: false
pomp_obj = pickle.load(open("train_results/dacca_results_rl4.pkl", "rb"))
pomp_obj_train = pickle.load(open("train_results/dacca_results_rl4_Adam.pkl", "rb"))
...
(
    ...
    + scale_x_continuous(limits=(-4000, None))
)
```
