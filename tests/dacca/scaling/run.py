"""Dhaka: GPU scaling of mif and pfilter over particle counts and chain counts.
...
# --- SLURM CONFIG ---
# importance: medium
# description: "Dhaka: scaling over particles and chains on GPU (runtime & memory)"
# tags: [scaling, dacca, gpu]
# jobs:
#   gpu:
#     sbatch_args:
#       job-name: "dacca scaling (gpu)"
...
def build(chains, key):
    ...
    return model.dacca(), starts, model.RW_SD
