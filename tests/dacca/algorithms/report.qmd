...
Both arms start from the same points drawn from the same box, and IF2 is given enough extra iterations that the two arms cost roughly the same wall clock. 
We would like to see which maximizes the likelihood more in the (roughly) same amount of time.
