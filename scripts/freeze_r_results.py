...
SPEC = [
    ...
    {
        "name": "spx/pfilter_check",
        "source": "tests/spx/pfilter_check/R_results/spx_results_eval.rda",
        "out_dir": "tests/spx/pfilter_check/R_reference",
        "produced_by": "tests/spx/pfilter_check/eval.R",
        "extractor": "pyreadr",
    ...
    {
        "name": "spx/performance",
        "source": "tests/spx/performance/R_results/search360_hidden/1d_global_search360.rda",
        "out_dir": "tests/spx/performance/R_reference",
        "produced_by": "tests/spx/performance/test.R",
        "extractor": "rscript",
